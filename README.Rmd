...
[![Codecov test coverage](https://codecov.io/gh/Sumidu/openaiassistant/branch/main/graph/badge.svg)](https://app.codecov.io/gh/Sumidu/openaiassistant?branch=main)
<!-- badges: end -->

The goal of openaiassistant is to provide access to the assistants API of OpenAI.
The package is low effort and not yet fully tested.
...
This can be done by the following code in R:
